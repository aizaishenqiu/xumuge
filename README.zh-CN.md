...
- `xu-desktop/role-packs-src/zh-virmoon`（约 **461** 岗）

自编译后可本地使用三闸门、写盘审批、演示岗包与大部分 UI；云登录、检查更新等能力可按需在 `.env` 中配置（见 `xu-desktop/.env.example`，占位域名为 `xxx.com`）。
